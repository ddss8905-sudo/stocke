...
create table if not exists screening_results (
  ...
  close_to_52w_low_ratio numeric,
  close_to_ma50_ratio numeric,
  base_depth_pct numeric,
  volume_dry_up_ratio numeric,
  trend_template_pass boolean default false,
  donchian20_breakout boolean default false,
  donchian55_breakout boolean default false,
  trend_raw numeric,
  rs_raw numeric,
  ...
  vcp_raw numeric,
  trend_template_raw numeric,
  setup_quality_raw numeric,
  ...
  sell_watch_price numeric,
  trend_exit_price numeric,
  two_r_price numeric,
